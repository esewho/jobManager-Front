...
export function ArrowCheckIn({ className, size }: IconProps) {
	return (
...
export function CheckOutIcon({ className, size }: IconProps) {
	return (
...
export function ResumeIcon({ size, className }: IconProps) {
	return (
		<svg width={size} height={size} className={className} viewBox="0 0 24 24">
			<path
				fill="#000000"
